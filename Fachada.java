...
public class Fachada {
	...
	public static void removerProdutoPedido(String telefone, String descricao) throws Exception{
		Cliente cli = restaurante.localizarCliente(telefone);
		if(cli == null) 
			throw new Exception("exclusao no pedido - cliente nao cadastrado");

		Pedido pedido = cli.obterPedidoAberto();
		if(pedido == null) 
			throw new Exception("exclusao no - nao existe pedido aberto do cliente:");

		Produto produto = restaurante.localizarProduto(descricao);
		if(produto == null)
			throw new Exception("exclusao no - produto nao cadastrado.");
	...
	public static  Pedido consultarPedido(String telefone) throws Exception {
		...
		if(cli.obterPedidoAberto()==null)
			System.out.println("Cliente "+telefone+" nao possui pedidos abertos");
	...
	public static void cancelarPedido(String telefone) throws Exception{
		...
		if(p==null)
			throw new Exception("Nao existe pedido em aberto para esse cliente.");
